This repository is connected with the article Kim, Bhattacharya and Maiti (2022). *Statistically valid variational Bayes algorithm for Ising model parameter estimation*. 
